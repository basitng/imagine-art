...
interface CommmunityImageProps {
  item: CommunityItem;
}

export default function CommmunityImage({ item }: CommmunityImageProps) {
    ...
    >
      ...
      >
        ...
        <div className="flex space-x-4">
          <span className="bg-white/20 rounded-full px-3 py-1 text-sm text-white flex items-center space-x-1">
            <Heart className="w-4 h-4" /> <span>{likes}</span>
          </span>
          <span className="bg-white/20 rounded-full px-3 py-1 text-sm text-white flex items-center space-x-1">
            <Download className="w-4 h-4" /> <span>{downloads}</span>
          </span>
        </div>
      </div>
    </div>
